...
<div id="containerRegistrar">
    <form id="creaProyecto" action="importarProyecto.php" name="formulario" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input type="text" id="n_idusuario" name="proyectoNombre" placeholder="Introduce el título del proyecto" required>
        </div>

        <div>
            <label for="descripcion">Descripción del Proyecto</label>
            <textarea id="n_idusuario" name="proyectoDescripcion" placeholder="Introduce la descripción del proyecto"></textarea>
        </div>

        <div>
            <label for="responsable">Responsable del Proyecto</label>
            <input type="text" id="n_idusuario" name="proyectoResponsable" placeholder="Introduce el nombre del responsable" required>
        </div>

        <div>
            <label for="fechaInicio">Fecha de Inicio</label>
            <input type="date" id="n_idusuario" name="proyectoInicio" required>
        </div>

        <div>
            <label for="fechaFin">Fecha de Fin (no puede ser antes que la Fecha de Inicio)</label>
            <input type="date" id="n_idusuario" name="proyectoFin" required>
        </div>

        <div>
            <label for="proyectoEstado">Estado del Proyecto</label>
            <select id="username" name="proyectoEstado">
        ...
        <div>
            ...
            <input type="int" id="n_idusuario" name="tamañoArchivo" required>
        </div>
            <div class="row">
                <div class="label"><label for="proyectoArchive">Archivo del proyecto</label></div>
                <div class="field">
                    <input type="file" id="n_idusuario" name="proyectoArchive">
                </div>
            </div>
