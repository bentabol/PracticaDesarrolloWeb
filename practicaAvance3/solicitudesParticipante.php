...
$solicitudesPendientes = $solicitudesRepository->getSolicitudesUsuario($_SESSION['idUsuario']);
                ...
                <table class="centro">
                    ...
                    <tbody>
                        <?php foreach ($solicitudesPendientes as $solicitud) : ?>
                            <tr>
                                <td><?= $solicitud->getn_idproyecto()->getn_idusuario()->getc_nickname() ?></td>
                                <td>
                                    <form name='nameForm' action='aceptarProyecto.php' method='post'>
